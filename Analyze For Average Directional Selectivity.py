...
def analyzeAcrossRetinas(trial_path, retina_paths, number_stimulus_variations, number_bars, x_axis_values, x_axis_label):
...
def analyzeWithinRetinasTwoSpeeds(trial_path, retina_paths, number_stimulus_variations, number_bars, x_axis_values, x_axis_label):
    ...
    for retina_number in range(number_retinas):
        ...
        for stimulus_number in range(0, number_stimulus_variations, 2):
            index = retina_number * number_stimulus_variations + stimulus_number
    ...
    fig1.tight_layout(pad=4.0, w_pad=6.0, h_pad=3.0)
    fig1_path = os.path.join(trial_path, "Directional Selectivity Results - Speed 1.jpg")
    fig1.savefig(fig1_path)        
    ...
    for retina_number in range(number_retinas):
        ...
        for stimulus_number in range(1, number_stimulus_variations, 2):
            index = retina_number * number_stimulus_variations + stimulus_number
    ...
    fig1.tight_layout(pad=4.0, w_pad=6.0, h_pad=3.0)
    fig1_path = os.path.join(trial_path, "Directional Selectivity Results - Speed 2.jpg")
    fig1.savefig(fig1_path)        
...
def analyzeWithinRetinasThreeDiffusions(trial_path, retina_paths, number_stimulus_variations, number_bars, x_axis_values, x_axis_label):
    ...
    for (stim_num_min, stim_num_max) in [[0, 18], [19, 37], [38, 56]]:    
        ...
        for retina_number in range(number_retinas):
            ...
            for stimulus_number in range(stim_num_min, stim_num_max+1):
                index = retina_number * number_stimulus_variations + stimulus_number
