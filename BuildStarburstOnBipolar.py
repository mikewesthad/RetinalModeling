...
retina.horizontal_layer.activities[0] = 1.0 * np.ones((1, retina.horizontal_layer.neurons))
retina.cone_layer.activities[0] = 1.0 * np.ones((1, retina.cone_layer.neurons))
