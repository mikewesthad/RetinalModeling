...
def analyze(trial_path, retina_paths, number_stimulus_variations, number_bars):
    ...
    for retina_number in range(number_retinas):
        for stimulus_number in range(number_stimulus_variations):
            ...
            fig1_rows, fig1_cols, fig1_index = 3, 4, 1
            fig1 = createFigure(20.0, fig1_rows, fig1_cols)
...
#            ax.set_ylim([0, max_DSI])
            ...
            fig1.tight_layout()
            fig1_path = os.path.join(trial_path, str(stimulus_number)+" Results.jpg")
...
trial_name = "Bar_Decay_Batch_Same_Morphology"
number_bars = 12
number_stimulus_variations = 13
